        ...
        <Container>
          ...
          <div className={style.social}>
            ...
            <ul className={style.socialList}>
              <li>
                <a href="#" className={cn(style.link, style.linkVK)}>
              ...
              <li>
                <a href="#" className={cn(style.link, style.linkFB)}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={style.development}>
            <ul className={style.developmentList}>
                <li className={style.developmentItem}>
                  Designer: 
                  <a className={style.link} href="https://t.me/Mrsmallowww">Anastasia Ilina</a>
                </li>
                <li className={style.developmentItem}>
                  Developer: 
                  <a className={style.link}  href="https://t.me/alexboagreek" target="_blank"></a>Aleksandr Sourkov
                </li>
            </ul>
          </div>
        </Container>
